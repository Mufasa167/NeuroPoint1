...
const ProfessionalCard = ({professional}) => {
  ...
  const{name, avgRating, totalRating,totalPatients,
    hospital, specialty}=professional
    ...
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        ...
        font-semibold rounded'>{specialty}
        </span>
      ...
      <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
        ...
        <Link to='/professionalsDetail' className='w-[44px] h-[44px] rounded-full border border-solid border=[#181A1E] mt-[30px]

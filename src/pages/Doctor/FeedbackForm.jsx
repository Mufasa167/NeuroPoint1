...
const FeedbackForm = () => {
    ...
    const starColor = (index) => {
        return index <= (rating && hover) || hover
          ? '#0066ff' // Replace with your actual iris blue color
          : '#333';   // Replace with your actual text color
      };
  ...
  return (
   <form action=''>
    <div>
        <h3 className='text-headingColor text-[16px] leading-6 font-semibold mb-4 mt-0'>How was your experience at the doctor's?</h3>
        <div>
    ...
    <h3 className='text-headingColor text-[16px] leading-6 font-semibold mb-4 mt-0'>Please share your feedback with us!</h3>
    ...
    onChange={(e)=>setReviewText(e.targert.value)}
    ></textarea>
    </div>
